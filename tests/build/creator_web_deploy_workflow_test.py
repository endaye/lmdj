...
GITHUB_TOKEN_STEPS = {
    ...
    "Deploy signed Creator Web Host release",
}
...
class CreatorWebDeployWorkflowTest(unittest.TestCase):
    ...
    def test_deployment_requires_manual_exact_tag(self) -> None:
        ...
        self.assertIn('scripts/creator-web-deploy.sh deploy "$tag"', source)
    ...
    def test_credentials_exist_only_in_the_deploy_step(self) -> None:
        ...
        deploy_step = self.step_named(source, "Deploy signed Creator Web Host release")
        ...
        self.assertEqual(
            deploy_environment,
            {
                ...
                "NETLIFY_CREATOR_SITE_ID": (
                    "${{ secrets.NETLIFY_CREATOR_SITE_ID }}"
                ),
    ...
    def test_workflow_scopes_secrets_and_always_uploads_evidence(self) -> None:
        source = self.workflow_source()
        self.assertIn(
            "NETLIFY_CREATOR_SITE_ID: ${{ secrets.NETLIFY_CREATOR_SITE_ID }}",
            source,
        )
        self.assertIn(
            "NETLIFY_AUTH_TOKEN: ${{ secrets.NETLIFY_AUTH_TOKEN }}",
        ...
        self.assertIn("build/deploy/creator-web/recovery-evidence.json", source)
    ...
    def test_internal_timeout_leaves_bounded_recovery_and_upload_budget(self) -> None:
        ...
        step_budgets = {
            ...
            "Install Chromium": 10,
            "Deploy signed Creator Web Host release": 35,
        ...
        main_budget = 1080
        deploy_step_budget = step_budgets["Deploy signed Creator Web Host release"] * 60
        setup_budget = sum(
            minutes
