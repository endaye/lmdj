...
expected_modules = {
    ...
    "packages/web-runtime-platform/module.json": (
        ...
        "0.1.0",
        1,
        {"application-facade": "1.3.0", "audio-runtime": "0.4.0"},
    ),
    "apps/core-cli/module.json": (
        "core-cli",
        "1.0.6",
        2,
        {"application-facade": "1.3.0"},
    ),
...
assert version == ProductVersion(1, 0, 16, 0)
assert str(version) == "1.0.16.0"
assert version.product_tag() == "lmdj-v1.0.16.0"
assert version.display("canary", "a" * 40) == (
    "1.0.16.0 · canary · gaaaaaaaa"
)
...
assert tag_name.stdout == "lmdj-v1.0.16.0\n"
...
assert current.stdout == "1.0.16.0 · canary · gaaaaaaaa\n"
...
assert verified.stdout == "version verification: PASS (1.0.16.0)\n"
...
assert assembly["product"] == {"id": "lmdj", "version": "1.0.16.0"}
...
assert compiled_product.group(1) == "1.0.16.0"
