...
assert version == ProductVersion(1, 0, 16, 1)
assert str(version) == "1.0.16.1"
assert version.product_tag() == "lmdj-v1.0.16.1"
assert version.display("canary", "a" * 40) == (
    "1.0.16.1 · canary · gaaaaaaaa"
)
...
assert tag_name.stdout == "lmdj-v1.0.16.1\n"
...
assert current.stdout == "1.0.16.1 · canary · gaaaaaaaa\n"
...
assert verified.stdout == "version verification: PASS (1.0.16.1)\n"
...
assert assembly["product"] == {"id": "lmdj", "version": "1.0.16.1"}
...
assert compiled_product.group(1) == "1.0.16.1"
