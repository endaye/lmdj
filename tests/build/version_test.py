...
expected_modules = {
    ...
    "packages/project-cooker/module.json": (
        ...
        "1.0.0",
        1,
        {"foundation": "0.3.0", "authoring-domain": "1.0.0"},
    ),
    ...
    "packages/audio-runtime/module.json": (
        ...
        "2.0.0",
        1,
        {"foundation": "0.3.0", "project-cooker": "1.0.0"},
    ),
    ...
    "packages/web-runtime-platform/module.json": (
        ...
        "2.0.1",
        1,
        {"application-facade": "2.1.0", "audio-runtime": "2.0.0"},
    ),
    "apps/core-cli/module.json": (
        "core-cli",
        "2.0.0",
        2,
        {"application-facade": "2.1.0"},
    ),
