...
assert version == ProductVersion(1, 0, 16, 4)
assert str(version) == "1.0.16.4"
assert version.product_tag() == "lmdj-v1.0.16.4"
assert version.display("canary", "a" * 40) == (
    "1.0.16.4 · canary · gaaaaaaaa"
)
...
assert tag_name.stdout == "lmdj-v1.0.16.4\n"
...
assert current.stdout == "1.0.16.4 · canary · gaaaaaaaa\n"
...
assert verified.stdout == "version verification: PASS (1.0.16.4)\n"
...
assert assembly["product"] == {"id": "lmdj", "version": "1.0.16.4"}
...
assert compiled_product.group(1) == "1.0.16.4"
