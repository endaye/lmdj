...
assert core_cli_manifest == {
    ...
    "version": "1.0.1",
    "api_version": 2,
    "dependencies": {"application-facade": "1.0.1"},
}

version = load_version("products/lmdj/version.json")
assert version == ProductVersion(1, 0, 10, 0)
assert str(version) == "1.0.10.0"
assert version.product_tag() == "lmdj-v1.0.10.0"
assert version.display("dev", "a" * 40) == "1.0.10.0 · dev · gaaaaaaaa"
...
assert tag_name.stdout == "lmdj-v1.0.10.0\n"
...
assert current.stdout == "1.0.10.0 · dev · gaaaaaaaa\n"
...
assert verified.stdout == "version verification: PASS (1.0.10.0)\n"
