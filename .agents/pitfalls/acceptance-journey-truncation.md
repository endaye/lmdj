...
ledger rather than shortening the journey. No eligible gate exists yet:
whether a test covers a journey leg is not mechanically decidable from the
repository, so this stays open as reviewer guidance.
