...
<!--
VENDORED, DO NOT EDIT THE BODY.

Source:   anthropics/claude-code, plugins/code-review/commands/code-review.md
Blob:     0b27765f17635137853df05bb7c122d39f1af3d7
Repo HEAD at retrieval: f173a697aa6486945f1b9c4aa9ce5383d2c87db6
Retrieved: 2026-09-03

Vendored rather than fetched at run time. `claude-code-action` clones a plugin
marketplace on every invocation, and on a self-hosted runner that clone is
unauthenticated and repeated often enough that GitHub rate-limits it:

    fatal: remote error: GitHub is temporarily limiting some unauthenticated
    downloads to protect the stability of the platform.

That failed both review backends before either reached a model. A copy in the
repository has no runtime dependency, and it also satisfies the rule this
repository already applies to the Grok CLI: anything executing on our own
runner beside repository credentials names its bytes.
