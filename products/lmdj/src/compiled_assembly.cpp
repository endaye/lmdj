...
lmdj::facade::CompiledAssemblyCatalog lmdj_catalog() {
  ...
  return lmdj::facade::CompiledAssemblyCatalog{
      ...
      "17cc4b06a4e074448a6cdfb3177f4564134197a45eb5affc6b8697909b934ae4",
      {
          ...
          CompiledComponent{"application-facade", "4.0.1"},
          CompiledComponent{"web-runtime-platform", "5.0.1"},
      },
      {
          CompiledComponent{"core-cli", "3.2.2"},
          CompiledComponent{"core-mcp", "3.2.2"},
          CompiledComponent{"native-host", "3.2.2"},
          CompiledComponent{"web-runtime-host", "4.1.2"},
          CompiledComponent{"creator-web", "4.1.2"},
      },
      {
