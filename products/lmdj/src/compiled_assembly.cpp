...
lmdj::facade::CompiledAssemblyCatalog lmdj_catalog() {
  ...
  return lmdj::facade::CompiledAssemblyCatalog{
      ...
      "17cc4b06a4e074448a6cdfb3177f4564134197a45eb5affc6b8697909b934ae4",
      {
          ...
          CompiledComponent{"authoring-domain", "4.0.0"},
          CompiledComponent{"project-io", "4.0.0"},
          CompiledComponent{"project-cooker", "1.1.1"},
          CompiledComponent{"audio-runtime", "4.0.1"},
          CompiledComponent{"provider-sdk", "2.2.0"},
          CompiledComponent{"application-facade", "5.0.0"},
          CompiledComponent{"web-runtime-platform", "5.2.0"},
      },
      {
          CompiledComponent{"core-cli", "3.3.2"},
          CompiledComponent{"core-mcp", "3.3.2"},
          CompiledComponent{"native-host", "3.3.2"},
          CompiledComponent{"web-runtime-host", "4.2.2"},
          CompiledComponent{"creator-web", "4.2.2"},
      },
      {
