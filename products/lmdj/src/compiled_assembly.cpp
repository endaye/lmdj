...
lmdj::facade::CompiledAssemblyCatalog lmdj_catalog() {
  ...
  return lmdj::facade::CompiledAssemblyCatalog{
      ...
      "17cc4b06a4e074448a6cdfb3177f4564134197a45eb5affc6b8697909b934ae4",
      {
          ...
          CompiledComponent{"authoring-domain", "2.0.0"},
          CompiledComponent{"project-io", "2.0.0"},
          CompiledComponent{"project-cooker", "1.1.0"},
          CompiledComponent{"audio-runtime", "3.0.0"},
          CompiledComponent{"provider-sdk", "1.1.4"},
          CompiledComponent{"application-facade", "3.0.0"},
          CompiledComponent{"web-runtime-platform", "3.0.0"},
      },
      {
          CompiledComponent{"core-cli", "3.0.0"},
          CompiledComponent{"core-mcp", "3.0.0"},
          CompiledComponent{"native-host", "3.0.0"},
          CompiledComponent{"web-runtime-host", "3.0.0"},
          CompiledComponent{"creator-web", "3.0.0"},
      },
      {
          CompiledComponent{"lmdj.project.v3", "3.0.0"},
          CompiledComponent{"lmdj.project.v4", "4.0.0"},
