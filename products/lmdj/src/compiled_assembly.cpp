...
lmdj::facade::CompiledAssemblyCatalog lmdj_catalog() {
  ...
  return lmdj::facade::CompiledAssemblyCatalog{
      ...
      "17cc4b06a4e074448a6cdfb3177f4564134197a45eb5affc6b8697909b934ae4",
      {
          ...
          CompiledComponent{"application-facade", "1.4.0"},
          CompiledComponent{"web-runtime-platform", "0.3.0"},
      },
      {
          CompiledComponent{"core-cli", "1.0.12"},
          CompiledComponent{"core-mcp", "1.1.9"},
          CompiledComponent{"native-test-host", "1.0.10"},
          CompiledComponent{"web-runtime-host", "1.2.9"},
          CompiledComponent{"creator-web", "1.2.0"},
      },
      {
