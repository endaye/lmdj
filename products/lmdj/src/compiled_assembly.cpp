...
lmdj::facade::CompiledAssemblyCatalog lmdj_catalog() {
  ...
  return lmdj::facade::CompiledAssemblyCatalog{
      ...
      "17cc4b06a4e074448a6cdfb3177f4564134197a45eb5affc6b8697909b934ae4",
      {
          ...
          CompiledComponent{"project-io", "0.5.3"},
          CompiledComponent{"project-cooker", "0.2.1"},
          CompiledComponent{"audio-runtime", "0.4.1"},
          CompiledComponent{"provider-sdk", "1.1.1"},
          CompiledComponent{"application-facade", "1.3.4"},
          CompiledComponent{"web-runtime-platform", "0.1.6"},
      },
      {
          CompiledComponent{"core-cli", "1.0.10"},
          CompiledComponent{"core-mcp", "1.1.7"},
          CompiledComponent{"native-test-host", "1.0.8"},
          CompiledComponent{"web-runtime-host", "1.2.6"},
          CompiledComponent{"creator-web", "1.0.6"},
      },
      {
