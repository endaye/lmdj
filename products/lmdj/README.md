...
source of truth for Product Build `1.0.16.3`. The lock binds every declared
...
- Implemented: Headless Core Proof, the Formal Native Host, Creator Web Host
  `1.0.2`, Formal Web Runtime Host `1.2.2`, and their shared Web Runtime
  Platform `0.1.2`. Browser Hosts depend only on that Platform; Product
