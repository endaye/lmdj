...
source of truth for Product Build `1.0.16.2`. The lock binds every declared
...
- Implemented: Headless Core Proof, the Formal Native Host, Creator Web Host
  `1.0.1`, Formal Web Runtime Host `1.2.1`, and their shared Web Runtime
  Platform `0.1.1`. Browser Hosts depend only on that Platform; Product
