...
source of truth for Product Build `1.0.16.8`. The lock binds every declared
...
- Implemented: Headless Core Proof, the Formal Native Host, Creator Web Host
  `1.0.5`, Formal Web Runtime Host `1.2.5`, and their shared Web Runtime
  Platform `0.1.5`. Browser Hosts depend only on that Platform; Product
