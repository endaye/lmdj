...
source of truth for Product Build `1.0.19.0`. The lock binds every declared
...
- Implemented: Headless Core Proof, the Formal Native Host, Creator Web Host
  `1.1.1`, Formal Web Runtime Host `1.2.7`, and their shared Web Runtime
  Platform `0.2.0`. Browser Hosts depend only on that Platform; Product
