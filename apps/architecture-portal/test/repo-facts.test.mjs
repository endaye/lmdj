...
test('facts match the current locked product composition', async () => {
  ...
  assert.equal(facts.product.version, '1.0.16.3');
  ...
  assert.deepEqual(facts.hosts.map(({id, version}) => ({id, version})), [
    {id: 'core-cli', version: '1.0.7'},
    {id: 'core-mcp', version: '1.1.4'},
    {id: 'creator-web', version: '1.0.2'},
    {id: 'native-test-host', version: '1.0.5'},
    {id: 'web-runtime-host', version: '1.2.2'},
  ]);
