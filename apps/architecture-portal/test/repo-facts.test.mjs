...
test('facts match the current locked product composition', async () => {
  ...
  assert.equal(facts.product.version, '1.0.16.9');
  ...
  assert.deepEqual(facts.hosts.map(({id, version}) => ({id, version})), [
    {id: 'core-cli', version: '1.0.10'},
    {id: 'core-mcp', version: '1.1.7'},
    {id: 'creator-web', version: '1.0.6'},
    {id: 'native-test-host', version: '1.0.8'},
    {id: 'web-runtime-host', version: '1.2.6'},
  ]);
