...
export function createWebRuntimeHostController(options = {}) {
  ...
  return Object.freeze({
    ...
    assignPatternSlot: session.assignPatternSlot,
    clearPatternSlot: session.clearPatternSlot,
    movePatternSlot: session.movePatternSlot,
    listPerformances: session.listPerformances,
    ...
    queryPerformanceRecordingStatus: session.queryPerformanceRecordingStatus,
    savePerformance: session.savePerformance,
    discardPerformance: session.discardPerformance,
    listPerformanceRecovery: session.listPerformanceRecovery,
    applyPerformanceRecovery: session.applyPerformanceRecovery,
    discardPerformanceRecovery: session.discardPerformanceRecovery,
    renamePerformance: session.renamePerformance,
    deletePerformance: session.deletePerformance,
    bindPerformanceRecording: session.bindPerformanceRecording,
    beginPerformanceReplay: session.beginPerformanceReplay,
    stopPerformanceReplay: session.stopPerformanceReplay,
    queryPerformanceReplayStatus: session.queryPerformanceReplayStatus,
    commitPerformanceResample: session.commitPerformanceResample,
