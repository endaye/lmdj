...
class PackageTest(unittest.TestCase):
    ...
    def test_package_is_deterministic_and_binds_every_required_identity(self) -> None:
        ...
        self.assertEqual(manifest["host_version"], "1.2.11")
        self.assertEqual(manifest["platform_version"], "0.3.2")
        ...
        self.assertIn(
            '<meta name="lmdj-host-version" content="1.2.11">', index
        )
        self.assertIn(
            '<meta name="lmdj-web-runtime-platform-version" content="0.3.2">',
            index,
        )
        self.assertIn(
