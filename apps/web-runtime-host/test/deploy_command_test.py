            ...
            if requested_id == PRIOR_DEPLOY_ID:
                ...
                self.send_json(
                    201,
                    {
                        ...
                        "deploy_ssl_url": f"https://{PRIOR_DEPLOY_ID}--lmdj-runtime.netlify.app",
                        "state": "ready",
...
"""
    ...
    def test_the_retired_deploy_verb_refuses_without_the_opt_in(self) -> None:
        ...
        self.assertIn("web-runtime-host", combined)
    ...
    def test_release_stage_uses_real_bundle_wrapper_and_detached_tag_checkout(self) -> None:
        ...
        # `create_owned_temp` in scripts/web-runtime-deploy.sh prefers RUNNER_TEMP but
        ...
        self.assertTrue(resolved.parent.name.startswith("lmdj-web-runtime-deploy."), resolved)
    ...
    def test_reconcile_rejects_unknown_third_deploy_id(self) -> None:
        ...
        self.server.reconcile_override_deploy_url = (
            "https://unknown-789--lmdj-runtime.netlify.app"
        )
        completed = self.run_command(
