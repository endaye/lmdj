...
- Execute `docs/superpowers/plans/2026-07-10-phase1-deploy.md` first; this plan consumes its `Dockerfile`, `compose.yml`, `Caddyfile`, `.env.example`, and environment-variable changes.
...
Execute every unchecked step in `docs/superpowers/plans/2026-07-10-phase1-deploy.md` before Task 1. The prerequisite is complete only when these files exist and the existing plan's verification passes:
