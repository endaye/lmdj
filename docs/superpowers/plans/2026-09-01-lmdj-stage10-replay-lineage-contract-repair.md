...
- Modify:
  `docs/superpowers/specs/2026-08-31-lmdj-stage12-candidate-adoption-lineage-design.md`
...
Use inline execution with `superpowers:executing-plans` in the current session;
