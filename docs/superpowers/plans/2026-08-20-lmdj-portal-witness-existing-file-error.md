...
- Create: `docs/superpowers/plans/2026-08-20-lmdj-portal-witness-existing-file-error.md` — bounded TDD implementation record and acceptance criteria.
...
git add docs/superpowers/plans/2026-08-20-lmdj-portal-witness-existing-file-error.md \\
