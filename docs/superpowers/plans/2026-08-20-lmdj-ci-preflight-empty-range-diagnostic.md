...
- Create: `docs/superpowers/plans/2026-08-20-lmdj-ci-preflight-empty-range-diagnostic.md` — scope, TDD, version, documentation, and acceptance record.
...
- Create: `docs/superpowers/plans/2026-08-20-lmdj-ci-preflight-empty-range-diagnostic.md`.
...
git status --short
git add docs/superpowers/plans/2026-08-20-lmdj-ci-preflight-empty-range-diagnostic.md scripts/ci/local_preflight.py tests/build/ci_local_preflight_test.py
