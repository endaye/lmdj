...
**Files:**
- Create: `docs/superpowers/plans/2026-08-31-lmdj-ci-heavy-failure-short-circuit.md`
...
git status --short
git add \
  docs/superpowers/plans/2026-08-31-lmdj-ci-heavy-failure-short-circuit.md \
