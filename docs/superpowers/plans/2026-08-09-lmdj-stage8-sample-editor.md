...
- The approved design is `docs/superpowers/specs/2026-08-08-lmdj-stage8-sample-editor-design.md`. A conflict returns to design review; implementation must not silently weaken it.
