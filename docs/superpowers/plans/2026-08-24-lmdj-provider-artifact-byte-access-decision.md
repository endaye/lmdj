...
- [x] `docs/quality/2026-08-17-manual-verification-todo.md`：Decisions 表的
  D3 行标记已决并链接决策文件。
- [x] `docs/superpowers/plans/2026-08-19-lmdj-attempt-replay-provider.md`
...
- [x] 修复两处将成为死链的引用：
  ...
  与 `docs/superpowers/plans/2026-08-19-lmdj-dsh-derived-hardening.md`。
...
`docs/superpowers/` 与 `docs/research/` 内，不涉及 architecture-portal 路由，
