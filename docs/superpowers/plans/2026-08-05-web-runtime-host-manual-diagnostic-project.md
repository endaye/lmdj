...
- The approved design is `docs/superpowers/specs/2026-08-05-web-runtime-host-manual-diagnostic-project-design.md`. A conflict returns to design review; implementation must not silently weaken it.
