...
- Create `docs/plans/2026-08-20-lmdj-version-lock-ordering.md` to record the selected paired-generation design, scope, TDD cycle, and acceptance gates.
...
**Files:**
- Create: `docs/plans/2026-08-20-lmdj-version-lock-ordering.md`
