...
- Modify: `docs/design/2026-07-26-staging-versioning-and-changelog-design.md`
...
rg -n "TBD|TODO|待定|待补" \
  ...
  docs/design/2026-07-26-staging-versioning-and-changelog-design.md
```
...
git add \
  ...
  docs/deploy/staging.md \
  docs/plans/2026-07-26-staging-versioning-and-changelog.md \
  docs/design/2026-07-26-staging-versioning-and-changelog-design.md \
