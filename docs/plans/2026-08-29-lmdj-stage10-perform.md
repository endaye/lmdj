...
[`2026-08-28-lmdj-stage10-perform-design.md`](../design/2026-08-28-lmdj-stage10-perform-design.md)
(P10-D1–D25), its six decision files, #488, the approved
[`2026-09-01-lmdj-stage10-replay-lineage-contract-design.md`](../design/2026-09-01-lmdj-stage10-replay-lineage-contract-design.md),
and the approved
...
[`2026-09-04-lmdj-stage10-creator-master-tap-projection-repair-design.md`](../design/2026-09-04-lmdj-stage10-creator-master-tap-projection-repair-design.md)
...
- The approved design is `docs/design/2026-08-28-lmdj-stage10-perform-design.md` (P10-D1–D25) plus its six decision files. Any conflict returns to design review; an implementation Task must not silently choose a different semantic.
...
- Create: dated `docs/plans/YYYY-MM-DD-lmdj-1-0-42-release-intent.md`
