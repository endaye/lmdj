...
Read the complete current `skill-creator/SKILL.md` before editing the skill; follow it. If advertised paths moved, locate them from current skill roots rather than using stale paths.
