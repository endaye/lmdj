...
- The authoritative stage ladder
  (`docs/design/2026-08-08-lmdj-stage8-sample-editor-design.md` §3)
...
- Read: `docs/design/2026-08-08-lmdj-stage8-sample-editor-design.md`
...
**Files:**
- Create: `docs/design/2026-08-15-lmdj-stage8b-pad-capture-design.md`
...
Work through the seven Design Gate questions with the user
...
git add docs/design/2026-08-15-lmdj-stage8b-pad-capture-design.md \
...
**Files:**
- Modify: `docs/plans/2026-08-15-lmdj-stage8b-pad-capture.md`
...
Stage 8 plan used (`docs/plans/2026-08-09-lmdj-stage8-sample-editor.md`):
...
> `docs/design/2026-08-15-lmdj-stage8b-pad-capture-design.md`
...
describe("CaptureController", () => {
  ...
  it("releases the microphone when stop lands during start", async () => {
    const {deps, track} = makeDeps();
    let release: (() => void) | undefined;
    const gate = new Promise<void>((resolve) => { release = resolve; });
    const slow = deps.getUserMedia;
    deps.getUserMedia = vi.fn(async (c) => { await gate; return slow(c); });
    const controller = new CaptureController(deps as never, {onBatch: vi.fn(), onEnded: vi.fn()});
