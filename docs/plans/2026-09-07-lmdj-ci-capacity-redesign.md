...
> 2026-09-08 更新：本文保留为上一阶段的历史实施计划。后续取消每日全量、引入
> 审查范围标签与主干合批的工作，使用 [新版实施计划](2026-09-08-lmdj-ci-incremental-batches.md)。
> 不按历史未勾选状态重复执行已完成的 O2，也不据此恢复每日自动测试。
...
本次声明文件仅为：
`docs/plans/2026-09-07-lmdj-ci-capacity-redesign.md`。
