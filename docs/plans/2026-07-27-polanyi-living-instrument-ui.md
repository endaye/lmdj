...
- 设计真相源是 `docs/design/2026-07-27-polanyi-living-instrument-ui-design.md`。
- `docs/design/2026-07-24-stage1-creator-workspace-ui-design.md` 的布局、断点、Square Pad、Uniform Gap、状态真实性与可访问性继续有效；本计划只覆盖其圆角、阴影、Hover 上移、缩放回弹和持续环境动效。
...
- Modify: `docs/design/2026-07-27-polanyi-living-instrument-ui-design.md`
