...
- 已确认产品与技术设计：`docs/design/2026-07-24-stage1-creator-core-slice-design.md`。
- 已确认 UI 设计：`docs/design/2026-07-24-stage1-creator-workspace-ui-design.md`；视觉实现以 `docs/design/2026-07-24-stage1-creator-workspace-ui-references/` 为校准基准。
...
桌面结构以 `docs/design/2026-07-24-stage1-creator-workspace-ui-references/instrument-first-desktop-v3.html` 为校准输入，但组件必须由 WorkbenchViewModel 驱动，不复制参考稿中的静态假数据。
...
Source、Processing、Ready、Review、Failed 与 Export 的层级和状态表现以 `docs/design/2026-07-24-stage1-creator-workspace-ui-references/stage1-product-states-v1.html` 校准；参考稿中的后置控件不得进入首条切片。
