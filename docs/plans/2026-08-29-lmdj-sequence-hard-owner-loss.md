...
> **For agentic workers:** Follow repository `AGENTS.md` to implement this single Task inline. Preserve
...
- Create: `docs/plans/2026-08-29-lmdj-sequence-hard-owner-loss.md`
...
- Modify: `docs/design/2026-08-22-sequence-recording-semantics-design.md`
