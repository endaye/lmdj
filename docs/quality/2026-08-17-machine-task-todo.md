...
| D1, D2 | Cooker Bank allocation, `PreparedSampleBank` publication accounting, manifest semantics, Facade validation, Web ingest bounds, and the `bank_quota_exhausted` failure class | **Blocked after readiness audit 2026-08-27** — the D1 + D2 product direction [decision](../prd/decisions/2026-08-26-long-material-quota-and-bpm-stretch.md) remains approved by [#339](https://github.com/endaye/lmdj/pull/339), and the original plan Task [#342](https://github.com/endaye/lmdj/issues/342) is complete. The audit found that four 16-Pad Bank quotas, the current 64-Pad Runtime generation, the 128 MiB live/pending/retiring total, revision-bound query/commit agreement, and pre-decode Web memory do not yet compose unambiguously. [#358](https://github.com/endaye/lmdj/issues/358) corrects the plan; decision gate [#357](https://github.com/endaye/lmdj/issues/357) blocks implementation [#343](https://github.com/endaye/lmdj/issues/343)–[#346](https://github.com/endaye/lmdj/issues/346); [#359](https://github.com/endaye/lmdj/issues/359) is the final macOS Safari / physical iPadOS acceptance gate for umbrella [#341](https://github.com/endaye/lmdj/issues/341) |
...
| D4, D5 | Stage 9 Sequence recording implementation (event-only Pattern Contract; the former "Sequence/Take Contract" naming is retired) | **Unblocked 2026-08-26** — the D4 + D5 [decision](../prd/decisions/2026-08-23-sequence-recording-semantics.md) merged in [#324](https://github.com/endaye/lmdj/pull/324); the work is decomposed into Stage 9 Tasks [#267](https://github.com/endaye/lmdj/issues/267)–[#275](https://github.com/endaye/lmdj/issues/275) under the [Stage 9 plan](../superpowers/plans/2026-08-23-lmdj-stage9-sequence-recording.md) |
