...
Ready PR [#334](https://github.com/endaye/lmdj/pull/334) reached snapshot
commit `147ab6cd3bff19d6bea0089ec3c8380b1dac98bd`. Full CI run
...
`f9b82d40517ddaafb757352ab92ea96916362af2`. Merged-main, publication and
promotion evidence remain pending until those separately authorized
boundaries occur.
...
| Transition | Status |
| --- | --- |
| Push | authorized; snapshot commit `147ab6cd3bff19d6bea0089ec3c8380b1dac98bd` and this ledger correction are pushed to the same short-lived branch |
| Pull Request | authorized; Ready [#334](https://github.com/endaye/lmdj/pull/334) is `CLEAN` / mergeable with `ci:full`; full CI and PR Gate passed at the snapshot commit, and later ledger-only validation remains attached to the PR |
